...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // =========================== //
  // LÓGICA DO MODAL DE EMAIL (NEWSLETTER) //
  // =========================== //
  const newsletterTriggerBtns = document.querySelectorAll(".open-newsletter-modal");
  newsletterTriggerBtns.forEach(btn => {
  ...
  const vejaOsPlanosBtn = document.getElementById("vejaOsPlanosBtn");
  if (vejaOsPlanosBtn)
